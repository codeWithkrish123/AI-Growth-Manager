        ...
        <div className="min-h-screen flex flex-col md:flex-row bg-white overflow-hidden font-sans">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 bg-white relative">
                ...
                <div className="w-full max-w-[440px]">
                    ...
                    {isLoggedIn ? (
                        <button onClick={() => navigate('/dashboard')} className="w-full h-[60px] bg-[#8B85F7] text-white font-black rounded-xl hover:bg-[#6C63FF]">Continue to Dashboard</button>
                    ) : (
                        <div className="space-y-6">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <button type="submit" className="w-full h-[60px] bg-[#8B85F7] text-white font-black text-sm uppercase tracking-widest rounded-2xl hover:bg-[#6C63FF]">CONTINUE</button>
                            </form>
                        </div>
                    )}
                </div>
